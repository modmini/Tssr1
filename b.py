...
ks = LINE()
ks.log("Auth Token : " + str(line.authToken))
ks.log("Timeline Token : " + str(line.tl.channelAccessToken))

kz = LINE()
kz.log("Auth Token : " + str(line.authToken))
...
kiMID = line.profile.mid
kkMID = line.profile.mid
kcMID = line.profile.mid
ksMID = line.profile.mid
kzMID = line.profile.mid
...
settings = {
    ...
    "message":"บัญชีนี้ถูกป้องกันโดยÜŃβÄḺḺระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""ÜŃβÄḺḺ:
╔══════════════┓
╠ ÜŃβÄḺḺ
╚══════════════┛""",
...
#==============================================================================#
                    ...
                    msg.contentType = 13
                    line.sendMessage(to, "=========================")
                    line.sendContact(to, "u9395d74dc4c37e1ffc1b9062ba64baf2")
                    line.sendMessage(to, "สงใสอะไรทักถามได้ครับ")
                    line.sendMessage(to, "=========================")
#===========
...
#==============================================================================#
                elif "ติดต่อ" == msg.text.lower():
                    line.sendMessage(to,"มีปัญหาเซลทักโดยตรงที่\n(｡◕‿◕｡)")
                    line.sendContact(to, "u9395d74dc4c37e1ffc1b9062ba64baf2")
                    ...
                    line.sendMessage(to, "(｡◕‿◕｡)")
                    line.sendContact(to, "u9395d74dc4c37e1ffc1b9062ba64baf2")
                    line.sendMessage(to,"ไห้เรียกผมว่า Ҩఖণಖஇ↭ধัюӄՁ่গს ขอไม่แสดง คท. นะครับ")
#==============================================================================#

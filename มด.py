...
RfuBot=[lineMID]
Family=["u88afa85cf3a0490b8d998756067a5f13",lineMID]
admin=['u88afa85cf3a0490b8d998756067a5f13',lineMID]
adminMID="u88afa85cf3a0490b8d998756067a5f13"
...
settings = {
    ...
    "Respontag":"┄┅⋆✮ᴛᴇᴀᴍʙᴏᴛ✮ℓஞ็நໂথ่ს✮⋆┅┄",
    "ResponPM":"┄┅⋆✮ᴛᴇᴀᴍʙᴏᴛ✮ℓஞ็நໂথ่ს✮⋆┅┄",
    "replyPesan": "Sorry , i'm busy right now.",
    "message":"รับติดบอททุกชนิด\nสนใจเช่าเชลบอท🔞\nติดต่อ ┄┅⋆✮ᴛᴇᴀᴍʙᴏᴛ✮ℓஞ็நໂথ่ს✮⋆┅┄",
    "comment":"┄┅⋆✮ᴛᴇᴀᴍʙᴏᴛ✮ℓஞ็நໂথ่ს✮⋆┅┄",
    "Wc":"กรุณาตั้งคนเข้า",
    "bye":"กรุณาตั้งคนออก",
    "pro":"กรุณาตั้งข้อความ",
    "add":"┄┅⋆✮ᴛᴇᴀᴍʙᴏᴛ✮ℓஞ็நໂথ่ს✮⋆┅┄",
...
┃👇👇 สนใจติดเซลติดต่อ 👇👇
┣━━━━━━━━━━━━━━━
┝━━{http://line.me/ti/p/~mod..1}
┝━━{http://line.me/ti/p/~chicric}
╰━━{http://line.me/ti/p/~Hmoklll}
    """
    return myHelp
def listgrup():
    key = settings["s"]
    key = key.title()    
    listGrup = """╭━━{┄┅⋆✮ᴛᴇᴀᴍʙᴏᴛ✮ℓஞ็நໂথ่ს✮⋆┅┄}
┣━━━━━━━━━━━━━━━
┃{ โหมดคำสั่งแทค }
┣━━━━━━━━━━━━━━━
┃•◈➣ แทค,แจ๊ะ
...
def lineBot(op):
    try:
        ...
        if op.type == 11:    
        	if line.getGroup(op.param1).preventedJoinByTicket == False:
        	   line.sendMessage(op.param1,"มีคนกำลังเปิดลิ้งกลุ่ม💫")
        if op.type == 13:
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    line.sendMentionFooter(to, '「ผู้คุมบอท」\n', sender, "https://line.me/ti/p/~mod..1", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~mod..1', 'type': 'mt', 'subText': settings["c"], 'a-installUrl': 'https://line.me/ti/p/~mod..1', 'a-installUrl': ' https://line.me/ti/p/~mod..1', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~mod..1', 'i-linkUri': 'https://line.me/ti/p/~mod..1', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~mod..1'}, contentType=19)
                elif text.lower() == "คท":
                    ...
                    start = time.time()
                    line.sendMessage(to, "┄┅⋆✮ᴛᴇᴀᴍʙᴏᴛ✮ℓஞ็நໂথ่ს✮⋆┅┄")
...
#-------------------------------------------------------------------------------------------------------------
                     ...
                     line.sendReplyMessage(msg.id, msg.to,"➢ ต้อนรับแยก\n\n➢ ชื่อกลุ่ม :\n"+ma+"\nจำนวน「%s」กลุ่ม" %(str(len(welcome))))
                elif msg.text == "คนออก":
                     ma = ""
                     a = 0
                     for group in leave:
                       ...
                       ma += str(a) + ". " +line.getGroup(group).name + "\n"
                     line.sendReplyMessage(msg.id, msg.to,"➢ อำลาแยก\n\n➢ ชื่อกลุ่ม :\n"+ma+"\nจำนวน「%s」กลุ่ม" %(str(len(leave))))    
                   ...
                   if msg._from in admin:
                    ...
                    for x in range(jml):
                        ...
                        line.sendMessage(to, "มาเล่นกันเถอะ".format(str(jml)))
                elif text.lower() == 'เทส':
...
#=====================================================================================#                        
                ...
                #----------------------------------------------------------------------------------------------------------------------------------------
                    ...
                    for x in range(jml):
                        if 'MENTION' in msg.contentMetadata.keys()!= None:
                            ...
                            for receiver in lists:                  
                                ...
                                line.sendMessage(receiver, "ukdjsjxo7282827',")
                        ...
                        if 'MENTION' in msg.contentMetadata.keys()!= None:
                            ...
                            for mention in mentionees:
                                if mention["M"] not in lists:
                                    lists.append(mention["M"])
                            for receiver in lists:
                                line.sendContact(receiver, "od.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God..God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God .3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God .3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God.3.God")
                                line.sendMessage(to, "ไปดู ส.ต ด้วย".format(str(jml)))
                            else:
                                pass
                    ...
                    line.sendMessage(msg.to, "┄┅⋆✮ᴛᴇᴀᴍʙᴏᴛ✮ℓஞ็நໂথ่ს✮⋆┅┄\n💫กรุณาพิมHelp 💫")                   
#==============================================================================#
...
#==============================================================================#
                    ...
                    for i in gid:
                        line.sendMessage(i,"[ ขอความประกาศกลุ่ม ]\n\n"+bc+"")
...
#==============================================================================#
                    ...
                    try:
                        ...
                        line.sendMessage(msg.to,"กรุณาส่งคอนแทค👇")                           
...
#==============================================================================#
                    ...
                    if msg.to in RfuCctv['point']:
                        ...
                        line.sendContact(to,"u6093de7200a0db19599459f9821714ce") 
                        line.sendContact(to,"ue8d02741193a607ffda1a46cf13856ae")
                        line.sendContact(to,"u88afa85cf3a0490b8d998756067a5f13")
                        line.sendContact(to,"u07a91918a04a0f8579b8bad3b17adda7")
...
#==============FINNISHING PROTECT========================#
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           ...
                           line.sendText(g.mid,"คิดถึงนะ🔞") 
                           line.sendText(g.mid,"คิดถึงนะ🔞")
                           line.sendText(msg.to, "เรียบร้อยแล้ว🍎")
   	                    #print (" Spammed !")
...
#=====================================================================================#                
                        ...
                        if settings["checkContact"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง...\n\n┄┅⋆✮ᴛᴇᴀᴍʙᴏᴛ✮ℓஞ็நໂথ่ს✮⋆┅┄", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                            settings["checkContact"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง....\n\n┄┅⋆✮ᴛᴇᴀᴍʙᴏᴛ✮ℓஞ็நໂথ่ს✮⋆┅┄", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
...
#            if settings ["Api"] == True:
 #               if msg.text in ["ฟา","ไข่ตุ่นคนดี","ม่อ","หำ"]:
  #                  line.sendText(msg.to,"🐯ยังอยู่ค่ะเฮียสบายใจได้🐯")
   #         if settings ["Api"] == True:
    #            if msg.text in ["ขอเสียงFcหน่อย"]:
     #               line.sendText(msg.to,"Fc เชลบอทฟารีส🔞")
         ...
         #       if msg.text in ["คถ","คิดถึง","คถ."]:
          #          line.sendMessage(msg.to,"คิดถึงเหมือนกันนะ (*_*)")
                if msg.text in ["/หลุดยัง"]:
                    line.sendMessage(msg.to,"ปกติครับ")
